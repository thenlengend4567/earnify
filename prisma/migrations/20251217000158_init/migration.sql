...
-- CreateEnum
CREATE TYPE "TaskType" AS ENUM ('AD', 'OFFER', 'REFERRAL', 'DAILY', 'OTHER');

-- CreateEnum
CREATE TYPE "TxType" AS ENUM ('EARN', 'WITHDRAW', 'BONUS');

-- CreateEnum
CREATE TYPE "TxStatus" AS ENUM ('COMPLETED', 'PENDING', 'FAILED');
